...
public class ErabiltzaileMezuaGehituGUI extends JFrame {
	...
	public ErabiltzaileMezuaGehituGUI(User nork, User nori,Erreklamazio erreklamazioa) {
		...
		JLabel Norklbl2 = new JLabel(nork.getErabiltzaileIzena()); //$NON-NLS-1$ //$NON-NLS-2$
		...
		NoriComboBox.addItem(nori.getName() + " ("+ResourceBundle.getBundle("Etiquetas").getString("AdminMezuaGehituGUI.Erreklamatzailea")+")");
		NoriComboBox.addItem("Administratzailea");
		...
		Bidali.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(!Testua.equals("")) {
					...
					else noribidali=null;
					
					
					facade.MezuaGehitu(nork, noribidali, Testua.getText(), erreklamazioa);
					itxi_lehioa(arg0);
					ErreklamazioakIkusiGUI lehioa=new ErreklamazioakIkusiGUI (nork);
