...
public class TestDataAccess {
	...
	public boolean existDriver(String email) {
		...
		public boolean TravelerNullalertaEzabatu(String nondik, String nora, Date data,Traveler t) {
			db.getTransaction().begin();
		    TypedQuery<Alerta> query = db.createQuery(
		            "SELECT a FROM Alerta a WHERE a.nondik = :from AND a.nora = :to AND a.data = :date AND a.traveler IS NULL",
		            Alerta.class
		        );
		        query.setParameter("from", nondik);
		        query.setParameter("to", nora);
